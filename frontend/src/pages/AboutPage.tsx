            ...
            >
              <div className="mb-8">
                ...
                <div className="space-y-4 text-text-secondary">
                  <p>
                    Hi there! I'm John, a passionate fullstack developer with 6+ years of professional 
                    experience building modern web applications. I specialize in creating robust, 
                    scalable solutions using cutting-edge technologies.
                  </p>
                  <p>
                    Throughout my career, I've worked on a diverse range of projects, from e-commerce 
                    platforms to enterprise SaaS applications. I thrive in collaborative environments 
                    and enjoy tackling complex challenges that push my skills to new heights.
                  </p>
                  <p>
